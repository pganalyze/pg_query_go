# pg_query_go [![GoDoc](https://godoc.org/github.com/formalco/pg_query_go/v4?status.svg)](https://godoc.org/github.com/formalco/pg_query_go/v4)
...
```
go get github.com/formalco/pg_query_go/v4@latest
```
